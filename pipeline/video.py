"""
wan.py
Wan2.1 Image-to-Video generation module for FitLens.
...
def generate_video(
    ...
    Args:
        image               : np.ndarray (RGB) — try-on result image
        gender              : "male" or "female" — drives gender-aware prompt
        motion              : "walking" | "turning" | "posing" | "windy"
        output_path         : where to save the .mp4
        num_frames          : number of video frames (default 81 ≈ ~3.4s @ 24fps)
